...
function start( amqpConn, twitterTokens ) {
  ...
  amqpConn.createChannel( function( err, ch ) {
    ...
    twitter.get( 'statuses/user_timeline', { since_id: config.history_since_id , user_id: config.follow, count: 200 }, function( err, tweets, response ) {
      publish( ch, tweets );
    });
  });
}
